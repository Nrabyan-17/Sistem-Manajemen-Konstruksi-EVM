    ...
    <div class="flex h-screen overflow-hidden bg-slate-50">
        ...
        <aside :style="isSidebarOpen ? 'width: 256px; min-width: 256px;' : 'width: 84px; min-width: 84px;'"
            ...
            <nav class="flex-1 px-3 py-4 space-y-1.5 overflow-y-auto no-scrollbar">
                ...
                <a href="/approvals" wire:navigate.hover
                   :class="{ 'justify-center px-2': !isSidebarOpen }"
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition {{ request()->is('approvals*') ? 'bg-blue-600 text-white font-semibold shadow-sm shadow-blue-500/30' : 'text-slate-600 hover:bg-slate-100' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="px-3 py-4 border-t border-slate-200 space-y-1">
                <a href="/login" :class="{ 'justify-center px-2': !isSidebarOpen }" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-red-600 hover:bg-red-50 text-sm font-semibold transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
