<div class="space-y-6">
    ...
    <div class="flex gap-4">
        ...
        {{-- Total Users --}}
        <div class="flex-1 bg-white rounded-2xl border border-slate-200 p-5 flex items-start justify-between shadow-sm">
            <div>
        ...
        <div class="flex-1 bg-white rounded-2xl border border-slate-200 p-5 flex items-start justify-between shadow-sm">
            ...
            <div class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636M15 10a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm flex flex-wrap items-center gap-3">
        ...
        <button class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 text-sm font-semibold text-white hover:bg-blue-700 transition shadow-sm shadow-blue-500/30 shrink-0">
                        ...
                        <td class="px-4 py-4">
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open"
                                    ...
                                    {{-- Deactivate User --}}
                                    <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-sm text-orange-600 hover:bg-orange-50 transition">
