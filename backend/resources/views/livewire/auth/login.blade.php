<div class="min-h-screen flex flex-col md:flex-row font-sans antialiased bg-white">
    ...
    <div class="relative w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-white">
        <div class="w-full max-w-md mx-auto">
            ...
            <!-- FORM -->
            <form wire:submit="login" x-data="{ isLoading: false }" @submit="isLoading = true" class="mt-8 space-y-5">
                <!-- Username -->
                <div>
                ...
                <button type="submit"
                        :disabled="isLoading"
                        class="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:opacity-80 disabled:cursor-not-allowed text-white font-semibold transition shadow-sm hover:shadow-md active:scale-[0.99]">
                    ...
                    <span x-show="isLoading" x-cloak class="font-medium">
                        Signing in...
                    </span>
                </button>
            </form>
